...
public class Processing {
    ...
    public Response process(Request request, DataBaseMng dataBaseMng) {
        String mes = commander.define(request.getCommand(), request.getArgument(), request.getProduct(), request.getUser(), dataBaseMng);
