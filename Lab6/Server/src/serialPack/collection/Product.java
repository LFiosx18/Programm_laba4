...
import serverLib.file.LocalDateAdapter;
...
public class Product implements Comparable<Product>, Serializable {
    ...
    public Product(String name, Coordinates coordinates, LocalDateTime creationDate, Long price, String partNumber, Integer manufactureCost, UnitOfMeasure unitOfMeasure, Organization manufacturer) {
        this.name = name;
        this.coordinates = coordinates;
        this.creationDate = creationDate;
        this.price = price;
